...
bool VL53L1X::init(bool io_2v8)
{
  ...
  //if (readReg16Bit(IDENTIFICATION__MODEL_ID) != 0xEACC) { return false; } //0xEACC = VL53L1
  if (readReg16Bit(IDENTIFICATION__MODEL_ID) != 0xEBAA) { return false; }   //0xEBAA = VL53L4CX
